...
# terraform plan -out ec2_s3.plan -var-file ec2_s3.tfvars
terraform plan -out ec2_s3.tfplan

# start terraform script 
terraform apply -auto-approve ec2_s3.tfplan

# destroy provisioned resource
# terraform plan -destroy -out ec2_s3.plan -var-file ec2_s3.tfvars
terraform plan -destroy -out ec2_s3.tfplan